...
import { TokenType } from "../../data-sctructure/enums"
...
const CompServerList = (props: {
  ...
  onRequestServerLogoutSelf: (server: ServerItem) => void
  onRequestServerLogoutOther: (server: ServerItem) => void
}) => {
  console.log(
        ...
        return (
          <Space>
            <CompServerRequest
              ...
              onRequestServerLogoutSelf={props.onRequestServerLogoutSelf}
              onRequestServerLogoutOther={props.onRequestServerLogoutOther}
            />
  ...
  return (
    <Card
      title={"用户列表"}
      bodyStyle={{ padding: 0 }}
      extra={<CompRowStatus servers={props.servers} users={props.users} />}
    >
      <Table
