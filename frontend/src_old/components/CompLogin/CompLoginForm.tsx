...
import { UserLogin, UserRegister } from "../../data-sctructure/interface"
...
const LoginForm = (props: { onClose: any; onAccountLogin: any }) => {
  ...
  const onLogin = async (
    userData: UserLogin,
    onAccountLogin: Function = props.onAccountLogin
  ) => {
    setWaiting(true)
    const dataEncoded = encodeAES(JSON.stringify(userData))
...
export default connect(null, (dispatch, ownProps) => {
  return {
    onAccountLogin: () =>
      dispatch({ type: ActionTypes.updateUserStatusLogined }),
  }
})(LoginForm)
